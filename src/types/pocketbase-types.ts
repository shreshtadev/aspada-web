...
export type AttachmentsResponse<Texpand = unknown> = Required<AttachmentsRecord> &
  BaseSystemFields<Texpand>
export type ChatCacheResponse<Tembedding = unknown, Texpand = unknown> = Required<
  ChatCacheRecord<Tembedding>
> &
  BaseSystemFields<Texpand>
export type ChatLogsResponse<Tmetadata = unknown, Texpand = unknown> = Required<
  ChatLogsRecord<Tmetadata>
> &
  BaseSystemFields<Texpand>
export type CompaniesResponse<Texpand = unknown> = Required<CompaniesRecord> &
  BaseSystemFields<Texpand>
export type LeadActivitiesResponse<Texpand = unknown> = Required<LeadActivitiesRecord> &
  BaseSystemFields<Texpand>
export type LeadsResponse<Texpand = unknown> = Required<LeadsRecord> & BaseSystemFields<Texpand>
export type MetadataResponse<Texpand = unknown> = Required<MetadataRecord> &
  BaseSystemFields<Texpand>
...
export type TestimonialsResponse<Texpand = unknown> = Required<TestimonialsRecord> &
  BaseSystemFields<Texpand>
